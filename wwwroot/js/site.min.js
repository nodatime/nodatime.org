...
*
*/
(function(n){var i=n.document,u="Install-Package",f=function(n,t,r){var o=[];t==null&&(t=i);r==null&&(r="*");for(var f=t.getElementsByTagName(r),s=f.length,h=new RegExp("(^|\\s)"+n+"(\\s|$)"),u=0,e=0;u<s;u++)h.test(f[u].className)&&(o[e]=f[u],e++);return o},r=function(n,t){var r=i.createTextNode(t);n.appendChild(r)},t=function(n){return i.createElement(n)},e=function(n,t){return n.getAttribute("data-nugetbutton-"+t)},o=function(){var y=f("nuget-button",null,"pre"),p=y.length,o,n,s;if(p.length!=0)for(o=0;o<p;++o)if(n=y[o],s=n.innerHTML.split(" "),s.length===2&&s[0]===u){var h=e(n,"link")||"true",c=s[1],l=t("div"),a=t("div"),i=t("p"),v=t("a");l.className="nuget-button-commandWrapper";a.className="nuget-button-commandPrompt";l.appendChild(a);i.className="nuget-button-command";r(i,"PM> "+u+" ");h==="false"?r(i,c):(v.setAttribute("href",h==="true"?"http://nuget.org/List/Packages/"+c:h),r(v,c),i.appendChild(v));a.appendChild(i);n.parentNode.replaceChild(l,n)}};o()})(window);$(document).foundation();hljs.initHighlightingOnLoad();const editorOrigin="https://try.dot.net";for(codeElement of document.getElementsByTagName("code"))if(codeElement.className==="language-csharp-trydotnet"){codeElement.className="language-csharp trydotnet";var pre=codeElement.parentElement,runDiv=document.createElement("div"),runButton=document.createElement("button");runButton.textContent="Copy to editor";runButton.className="trydotnetbutton";runDiv.appendChild(runButton);createListener=n=>()=>setCode(n);runButton.addEventListener("click",createListener(codeElement.textContent));pre.parentNode.insertBefore(runButton,pre.nextSibling)}document.addEventListener&&document.addEventListener("DOMContentLoaded",function(){document.getElementById("trydotnet-run").addEventListener("click",runCode)});window.addEventListener&&window.addEventListener("message",n=>{n.origin===editorOrigin&&(n.data.type==="RunCompleted"&&processRunResults(n.data),n.data.type==="HostListenerReady"&&(setupWorkspace(),showEditor()))});