...
The range for [`Instant64`](noda-type://NodaTime.HighPerformance.Instant64) is derived from its internal representation as
"a signed 64-bit integer number of nanoseconds from the Unix epoch".

This means the range is from 1677-09-21T00:12:43.145224192Z to 2262-04-11T23:47:16.854775807Z inclusive.
...
The range for [`Duration64`](noda-type://NodaTime.HighPerformance.Duration) is derived from its internal representation as
