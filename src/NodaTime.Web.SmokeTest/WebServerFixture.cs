...
namespace NodaTime.Web.SmokeTest
{
    ...
    public class WebServerFixture
    {
        ...
        {
            // If we didn't start successfully, we don't need to stop anything.
            if (serverCancellation == null || serverTask == null)
            {
                return;
            }
        ...
        {
            string[] expectedFiles = { "README.md", "LICENSE.txt", "NOTICE.txt", "global.json" };
